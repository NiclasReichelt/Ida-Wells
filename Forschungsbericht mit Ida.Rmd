...
## Nach Ida (47 Verbindungen) haben Booker T Washington und W. E. B. DuBois mit 8 Verbindungen den höchsten Degreewert. Danach folgt Susan B Anthony mit 7 Verbindungen.

# Motivation: Frauenrechte
degree(Ida_mot_woman, mode="all")
which.max(degree(Ida_mot_woman, mode="all"))
## Booker T Washington und W. E. B. DuBois haben mit 8 Verbindungen den zweithöchsten Degreewert nach Ida (nach 47 Verbindungen). Darauf folgen Susan B. Anthony (7 Verbindungen) und Mary Church Terrell (6 Verbindungen). Verhätnismäßig wenige Personen haben wenige Verbindungen zu anderen Knoten. 

# Motivation: Frauenrechte & Schwarzenrechte
degree(Ida_mot_both, mode="all")
which.max(degree(Ida_mot_both, mode="all"))
## Wie erwartet haben Booker T Washington, W. E. B. DuBois, Susan B. Anthony und Mary Church Terrell den höchsten Degreewert nach Ida. 
```
